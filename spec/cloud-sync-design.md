...
**实现细节**：
- 服务按钮使用官方多色 SVG logo（`public/icons/google-drive.svg`、`public/icons/onedrive.svg`）
- 所有同步子视图统一使用 `py-16` 垂直间距，与时间线 EmptyState 对齐
- 页面内边距使用 `px-5 pt-5 pb-24 sm:px-6 lg:px-8`，与 PageLayout 规范一致
